const categoriesData = {
    ...
    'drinks': {
        name: 'مشروبات',
        items: [
            { id: 'drink1', name: 'عصير ليمون', price: 7500, image: 'https://i.imgur.com/uG5H8rD.png', description: 'عصير طبيعي طازج' },
            { id: 'drink2', name: 'مياه غازية', price: 6000, image: 'https://i.imgur.com/R0H7OQh.png', description: 'منعشة ومنكهة' }
        ]
    },
    'sweets': {
        name: 'حلويات',
        items: [
            { id: 'sweet1', name: 'كيك شوكولا', price: 12000, image: 'https://i.imgur.com/wV8t43S.png', description: 'كيك يومي صغير' },
            { id: 'sweet2', name: 'حلويات عربية', price: 25000, image: 'https://i.imgur.com/aM8XJ3H.png', description: 'بقلاوة مشكلة فاخرة' }
        ]
    },
    'fast_food': {
        name: 'وجبات سريعة',
        items: [
            { id: 'fastfood1', name: 'بيتزا', price: 25000, image: 'https://i.imgur.com/tYx4I7A.png', description: 'حجم وسط' },
            { id: 'fastfood2', name: 'شاورما', price: 18000, image: 'https://i.imgur.com/k6lP3sQ.png', description: 'شاورما دجاج' }
        ]
    },
    'flowers': {
        name: 'ورد',
        items: [
            { id: 'flower1', name: 'باقة توليب', price: 30000, image: 'https://i.imgur.com/9C5pG3T.png', description: 'باقة توليب متعددة الألوان' },
            { id: 'flower2', name: 'صبار زينة', price: 15000, image: 'https://i.imgur.com/vH1Wf4u.png', description: 'نبات صبار صغير في أصيص' }
        ]
    },
    'supermarket': {
        name: 'سوبر ماركت',
        items: [
            { id: 'super1', name: 'شاي أخضر', price: 5500, image: 'https://i.imgur.com/h9D6s6e.png', description: 'أكياس شاي 250 غرام' },
            { id: 'super2', name: 'قهوة سريعة', price: 9000, image: 'https://i.imgur.com/2YcW7bL.png', description: 'بنكهة البندق' },
            { id: 'super3', name: 'زيت نباتي', price: 22000, image: 'https://i.imgur.com/3p3rF3I.png', description: 'زيت دوار الشمس 1 لتر' },
            { id: 'super4', name: 'سكر', price: 8000, image: 'https://i.imgur.com/m52sM2E.png', description: '1 كغ' }
        ]
    },
    'best_sellers': {
        name: 'الأكثر مبيعاً',
...
container.addEventListener("scroll", () => {
    ...
    dots.forEach((dot, i) => {
        dot.classList.toggle("active-dot", i === closestIndex);
    });
...
setInterval(() => {
    ...
    const targetCard = offerCards[currentIndex];
    offerContainer.scrollTo({ left: targetCard.offsetLeft, behavior: 'smooth' });
...
function renderAllFoodItems() {
    ...
    renderFoodItems('drinksGrid', 'drinks');
    renderFoodItems('sweetsGrid', 'sweets');
    renderFoodItems('fast_foodGrid', 'fast_food');
    renderFoodItems('flowersGrid', 'flowers');
    renderFoodItems('supermarketGrid', 'supermarket');
    // No need to render favorites from here, it has its own function
}
...
قيمة التوصيل إلى ${areaName}: ${deliveryFeeFinal.toLocaleString()} ل.س`;
    ...
    orderSummary += `
المجموع النهائي: ${total.toLocaleString()} ل.س`;
